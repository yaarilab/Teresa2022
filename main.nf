...
Channel.value(params.mate).set{g_42_mate_g_61}
if (params.reads){
Channel
...
input:
 set val(name),  file(reads) from g_52_reads_g_61
 val mate from g_42_mate_g_61

output:
 file "*clonotypes.ALL.txt"  into g_61_outputFileTxt0_g_37
 file "*.report"  into g_61_outputFileTxt11
 file "*.report0[0-4]"  into g_61_outputFileTxt2_g_36
 file "*.clonotypes.*.txt"  into g_61_outputFileTxt3_g_47
...
input:
 file file from g_61_outputFileTxt2_g_36.collect()

output:
 file "01_mixcr_qc.html"  into g_36_outputFileHTML00
 file "01*{.out,tab,tsv,csv,png}"  into g_36_outputFileTxt1_g_43, g_36_outputFileTxt1_g_58, g_36_outputFileTxt1_g_37
...
input:
 file files_all from g_36_outputFileTxt1_g_37.collect()
 file files_all from g_61_outputFileTxt0_g_37.collect()

output:
 file "02_datafiltering.html"  into g_37_outputFileHTML00
 file "02*{.out,tab,csv,tsv,png}"  into g_37_outputFileTxt1_g_43, g_37_outputFileTxt1_g_58
 file "clones_*_filtered"  into g_37_outputDir2_g_47, g_37_outputDir2_g_53, g_37_outputDir2_g_54, g_37_outputDir2_g_57
 file "clones_*_filtered.Rda"  into g_37_outputFileTxt3_g_48
...
input:
 file files from g_36_outputFileTxt1_g_43
 file files from g_37_outputFileTxt1_g_43

output:
 file "03_dataset_overview.html"  into g_43_outputFileHTML00
 file "03*{.out,tab,csv,tsv,png}"  into g_43_outputFileTxt1_g_44, g_43_outputFileTxt1_g_58
...
input:
 file files from g_43_outputFileTxt1_g_44

output:
 file "04_correlations.html"  into g_44_outputFileHTML00
 file "04*{.out,tab,csv,tsv,png}"  into g_44_outputFileTxt1_g_47, g_44_outputFileTxt1_g_58
...
input:
 file file from g_44_outputFileTxt1_g_47.collect()
 file file from g_61_outputFileTxt3_g_47.collect()
 file dir from g_37_outputDir2_g_47

output:
 file "05_overlap.html"  into g_47_outputFileHTML00
 file "05*{.out,tab,csv,tsv,png}"  into g_47_outputFileTxt1_g_48, g_47_outputFileTxt1_g_58
...
input:
 file files from g_47_outputFileTxt1_g_48
 file files from g_37_outputFileTxt3_g_48

output:
 file "06_diversity.html"  into g_48_outputFileHTML00
 file "06*{.out,tab,csv,tsv,png}"  into g_48_outputFileTxt1_g_53, g_48_outputFileTxt1_g_58
...
input:
 file files from g_48_outputFileTxt1_g_53
 file dir from g_37_outputDir2_g_53

output:
 file "07_kmers.html"  into g_53_outputFileHTML00
 file "07*{.out,tab,csv,tsv,png}"  into g_53_outputFileTxt1_g_54, g_53_outputFileTxt1_g_58
...
input:
 file files from g_53_outputFileTxt1_g_54
 file dir from g_37_outputDir2_g_54

output:
 file "08_network.html"  into g_54_outputFileHTML00
 file "08*{.out,tab,csv,tsv,png}"  into g_54_outputFileTxt1_g_57, g_54_outputFileTxt1_g_58
...
input:
 file files from g_54_outputFileTxt1_g_57
 file dir from g_37_outputDir2_g_57

output:
 file "09_ddbb.html"  into g_57_outputFileHTML00
 file "09*{.out,tab,csv,tsv,png}"  into g_57_outputFileTxt1_g_58
...
input:
 file files from g_36_outputFileTxt1_g_58
 file files from g_43_outputFileTxt1_g_58
 file files from g_44_outputFileTxt1_g_58
 file files from g_48_outputFileTxt1_g_58
 file files from g_53_outputFileTxt1_g_58
 file files from g_54_outputFileTxt1_g_58
 file files from g_57_outputFileTxt1_g_58
 file files from g_47_outputFileTxt1_g_58
 file files from g_37_outputFileTxt1_g_58
